<%@ Page Title="" Language="C#" MasterPageFile="~/Pafe1.Master" AutoEventWireup="true" CodeBehind="Default4.aspx.cs" Inherits="WebApplication7.Default4" %>
...
&nbsp;<asp:TextBox ID="TextBox2"  runat="server" TextMode="Password"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" AutoPostBack="true" ControlToValidate="TextBox2" Text="Заполните поле!" Display="Dynamic" ErrorMessage="Error"></asp:RequiredFieldValidator>
    <br />
