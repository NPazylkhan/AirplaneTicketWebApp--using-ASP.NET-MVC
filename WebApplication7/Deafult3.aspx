<%@ Page Title="" Language="C#" MasterPageFile="~/Pafe1.Master" AutoEventWireup="true" CodeBehind="Deafult3.aspx.cs" Inherits="WebApplication7.Deafult3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Жд билеты купить онлайн.Купить билеты на поезд в Казахстане/Tickets.kz
</asp:Content>
